...
Usable in any Shapeshift form.` },
	...
	{ id: 'natures-cycle', name: 'Nature\'s Cycle', maxPoints: 5, row: 1, col: 0, icon: 'ability_demonhunter_chaoticimprint_nature.jpg', description: (p) => `Increases the damage done by your periodic spells and Bleed effects by ${p * 2}%. In addition, the time required for your Wild Mushroom to detonate is reduced by ${p * 10}%.` },
        { id: 'improved-moonfire', name: 'Improved Moonfire', maxPoints: 5, row: 1, col: 1, icon: 'spell_nature_starfall.jpg', description: (p) => `Increases the damage of your Moonfire spell by ${p * 4}% and causes Moonfire to increase Arcane damage taken by the target by ${p * 1}%.` },
            { id: 'majesty', name: 'Majesty', maxPoints: 3, row: 1, col: 2, icon: 'inv_staff_01.jpg', description: (p) => `Increases your critical strike chance with all attacks and spells by ${p * 2}% in all forms. This effect is doubled versus Beasts.` },
...
<br>
<br>
In addition, your Moonfire and Starfire critical strikes and grant you ${values[p - 1]}% of your mana regeneration while casting. Lasts 15 sec.`;}},
...
Feral Charge (Cat) causes your next Ravage to not require stealth or have a positioning requirement for 10 sec.` },
	{ id: 'nurturing-instinct', name: 'Nurturing Instinct', maxPoints: 2, row: 1, col: 3, icon: 'ability_druid_healinginstincts.jpg', description: (p) => `Increases your healing spells by up to ${p * 50}% of your Agility, and increases healing received by ${p * 10}% while in Cat and Moonkin Forms.` },
            { id: 'agitation', name: 'Agitation', maxPoints: 3, row: 3, col: 1, icon: 'spell_druid_bristlingfur.jpg', description: (p) => `Shred costs ${p * 10} less Energy and has a ${p * 10}% chance to reset the cooldown of Mangle (Cat).
<br>
<br>
Lacerate costs ${p} less Rage and has a ${p * 10}% chance to reset the cooldown of Mangle (Bear).` },
            { id: 'predatory-instincts', name: 'Predatory Instincts', maxPoints: 1, row: 4, col: 1, icon: 'ability_hunter_pet_cat.jpg', description: (p) => `Increases your Attack Power in Cat Form and Bear Form by 150% of your level. In addition, you generate 3 Rage when you dodge while in Bear Form or 5 Energy while in Cat Form. ` },
...
Usable in any Shapeshift form.` },
	...
	{ id: 'king-of-the-jungle', name: 'King of the Jungle', maxPoints: 2, row: 5, col: 0, prereq: 'leader-of-the-pack', icon: 'ability_druid_kingofthejungle.jpg', description: (p) => `Your Tiger's Fury ability in Cat Form instantly provides ${p * 20} Energy. In addition, while Tiger's Fury is on cooldown your finishing moves in Cat Form grant ${p * 2} Energy per combo point.` },
		...
		{ id: 'ursine-savagery', name: 'Ursine Savagery', maxPoints: 2, row: 5, col: 2, prereq: 'leader-of-the-pack', icon: 'spell_druid_malfurionstenacity.jpg', description: (p) => `Your basic attacks in Bear Form have a chance equal to your chance to hit to cause a Fury Swipe, dealing ${p * 30}% weapon damage.` },
...
Usable in Cat Form or Bear Form.` },
    ...
    'restoration': {
        name: 'Restoration',
        talents: [
            { id: 'improved-mark-of-the-wild', name: 'Improved Mark of the Wild', maxPoints: 2, row: 0, col: 1, icon: 'spell_nature_regeneration.jpg', description: (p) => `Increases the effects of your Mark of the Wild and Gift of the Wild spells by ${p * 20}%.` },
