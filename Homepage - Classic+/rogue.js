...
This effect only triggers from enemies that yield experience or honor.` },
	...
	{ id: 'gutted-fish', name: 'Gutted Fish', maxPoints: 3, row: 1, col: 3, icon: 'ability_rogue_surpriseattack.jpg', description: (p) => `While your target is at or below 30% health, your Shuriken Toss and ranged abilities cause the target to bleed for damage equal to ${p * 5}%  of your Attack Power over 10 sec.
<hr>
Periodic damage from this effect always critically strikes moving targets.` },
	{ id: 'quickening', name: 'Quickening', maxPoints: 2, row: 0, col: 3, icon: 'ability_rogue_quickrecovery.jpg', description: (p) => { const healingValues = [5, 10]; return `Healing effects on you are increased by ${healingValues[p - 1]}% while below 60% health and critical heals you receive reduce the cooldown of your Evasion by ${p} sec.`;}},
	...
	{ id: 'venomous-wounds', name: 'Venomous Wounds', maxPoints: 5, row: 5, col: 2, icon: 'ability_rogue_venomouswounds.jpg', description: (p) => `Each time your Rupture or Garrote deals damage to a poisoned enemy, you have a ${p * 6}% chance to deal additional Nature damage and regain 10 Energy.` },
	 ...
	 { id: 'serrated-blades', name: 'Serrated Blades', maxPoints: 3, row: 2, col: 1, icon: 'inv_sword_17.jpg', description: (p) => `Causes your attacks to ignore up to ${p * 3}% of your target's Armor and increases the damage dealt by your Rupture ability by ${p * 10}%.` },
...
<br>
Mace/Thrown -  Daze the target for 3 sec.
<br>
Sword/Fist Weapon - Gain an extra attack.
<hr>
Switching weapons during combat places this effect on a 30 sec cooldown.` },
		{ id: 'serpents-cunning', name: 'Serpent\'s Cunning', maxPoints: 3, row: 4, col: 1, icon: 'ability_rogue_preyontheweak.jpg', description: (p) => `Your offhand weapon deals ${p * 10}% increased damage to poisoned or bleeding targets. In addition, targets that are both poisoned and bleeding have a ${p * 2}% reduced chance to critically strike you.` },
		...
		{ id: 'unseen-blade', name: 'Unseen Blade', maxPoints: 1, row: 3, col: 3, prereq: 'improved-kick', icon: 'inv_knife_1h_etherealtool_b_01.jpg', description: (p) => `You store a hidden dagger in your boot. Kicking a target deals 50% off-hand weapon damage and applies Occult Poision, causing them to take 3% increased Nature and Shadow damage for 30 sec.` },
		...
		{ id: 'unfair-advantage', name: 'Unfair Advantage', maxPoints: 5, row: 5, col: 1, icon: 'ability_rogue_unfairadvantage.jpg', description: (p) => `Whenever you dodge or parry an attack you strike back for ${p * 20}% of your off-hand weapon's damage and increase your chance to parry by ${p * 20}% for 5 sec or until you successfully parry.<hr>This effect can occur once every 15 sec.` },
		{ id: 'honor-among-thieves', name: 'Honor Among Thieves', maxPoints: 3, row: 5, col: 2, icon: 'ability_rogue_honoramongstthieves.jpg', description: (p) => `Increases the critical strike chance of party members within 15 yds by ${p * 1}%. In addition, when a party member critically strikes, there is a ${p * 15}% chance you generate 5 Energy and Riposte becomes active for 6 sec.` },
	...
	{ id: 'master-of-deception', name: 'Master of Deception', maxPoints: 5, row: 0, col: 2, icon: 'spell_shadow_charm.jpg', description: (p) => `Reduces the chance enemies have to detect you while in Stealth. In addition, your first ability after leaving Stealth deals an additional ${p * 2}% damage.` },
            ...
            { id: 'smoke-bomb', name: 'Smoke Bomb', maxPoints: 1, row: 6, col: 2, prereq: 'dirty-deeds', icon: 'ability_rogue_smoke.jpg', subDetails: ['0.5 sec cast','Reagents: <br> Flash Powder'], details: ['20 yd range', '2 min cooldown'], description: () => `Toss a bomb that creates smoke in a 10 yard radius for 8 sec. Creatures outside cannot target into the cloud, and creatures inside have a 20% reduced chance to hit, modified by Stealth detection.
<hr>
Ineffective on enemies higher than level 61 or which are marked as boss enemies.` },
		{ id: 'ghostly-strike', name: 'Ghostly Strike', maxPoints: 1, row: 2, col: 1, icon: 'spell_shadow_curse.jpg', subDetails: ['40 Energy','Instant'], details: ['Melee Range', '20 sec cooldown'], description: () => `A strike that deals 115% weapon damage and grants you Ghosting for 10 sec. Awards 1 combo point.<hr>Ghosting increases your chance to Dodge by 10% and allows you to Backstab enemies facing you.` },
...
Waylay can occur once every 45 sec.` },
            ...
            { id: 'soothing-darkness', name: 'Soothing Darkness', maxPoints: 2, row: 5, col: 3, icon: 'rogue_shadow_reflection.jpg', description: (p) => `Increases your Stealth detection, reduces the cooldown of your Stealth ability by ${p * 2} sec, and your Vanish now heals you for ${p * 20}% of your missing health.` },
            { id: 'preparation', name: 'Preparation', maxPoints: 1, row: 4, col: 1, icon: 'ability_rogue_preparation.jpg', details: ['5 min cooldown'], subDetails: ['Instant'], description: () => `When activated, this ability immediately finishes the cooldown on your Evasion, Sprint and Vanish abilities.` },
            { id: 'dirty-deeds', name: 'Dirty Deeds', maxPoints: 2, row: 4, col: 2, icon: 'ability_rogue_dirtydeeds.jpg', description: (p) => `Reduces the Energy cost of your Cheap Shot and Garrote  by ${p * 5} and your Backstab deals ${p * 5}% more damage to targets above 70% health.` },
            { id: 'hemorrhage', name: 'Hemorrhage', maxPoints: 1, row: 4, col: 3, icon: 'spell_shadow_lifedrain.jpg', subDetails: ['30 Energy','Instant'], details: ['Melee Range'], description: () => `An instant attack that causes 110% weapon damage and causes the target to hemorrhage, increasing any Physical damage dealt to the target. Lasts 15 charges or 15 sec. Awards 1 combo point.` },
		{ id: 'setup', name: 'Setup', maxPoints: 2, row: 1, col: 1, icon:'ability_ironmaidens_darkhunt.jpg', description: (p) => { const values = [50, 100]; return `Gives you a ${values[p - 1]}% chance to add a combo point to your target after dodging their attack or fully resisting one of their spells.<hr>This effect can occur once per sec.`;}},
            { id: 'blackjack', name: 'Blackjack', maxPoints: 2, row: 3, col: 1, icon: 'ability_rogue_blackjack.jpg', description: (p) => `Gives you a ${p * 50}% chance to return to stealth mode after using your Sap ability. In addition, after your Sap wears off, the target's damage and healing are reduced by ${p * 5}% for 8 sec.` },
            { id: 'deadliness', name: 'Deadliness', maxPoints: 5, row: 2, col: 0, icon: 'inv_weapon_crossbow_11.jpg', description: (p) => `Reduces the energy cost of your Backstab and Ambush abilities by ${p * 4} and increases all damage done by ${p * 1}%.` },
	{ id: 'dead-of-night', name: 'Dead of Night', maxPoints: 3, row: 4, col: 0, icon: 'spell_shadow_twilight.jpg', description: (p) => `Allows Shadowstep to be used outside of Stealth and reduces its cooldown by ${p * 10} sec. In addition, Ghosting increases your skill with your main-hand weapon by ${p * 2}.` },
            { id: 'premeditation', name: 'Premeditation', maxPoints: 1, row: 6, col: 1, isUltimate: true, prereq: 'preparation', icon: 'spell_shadow_possession.jpg', details: ['30 sec cooldown'], subDetails: ['30 yd range', 'Instant',"Requires Stealth"], description: () => `When used, adds 2 combo points to your target.  You must add to or use those combo points within 20 sec or the combo points are lost.` },
	        ]
    }
};
