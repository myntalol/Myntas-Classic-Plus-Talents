...
Increases the effect of your Curse of Weakness by ${p * 10}% and increases the energy, rage or focus costs of the target's abilities by ${p * 5}% while active.` },
	...
	{ id: 'face-of-terror', name: 'Face of Terror', maxPoints: 2, row: 2, col: 0, icon: 'ability_warlock_darkarts.jpg', description: (p) => `Reduces the cast time of your Howl of Terror spell by ${p * 0.5} sec. In addition, your Fear spell reduces the target's movement speed by ${p * 10}% whenever the effect ends. Lasts 5 sec.` },
            { id: 'fel-concentration', name: 'Fel Concentration', maxPoints: 5, row: 1, col: 3, icon: 'spell_shadow_fingerofdeath.jpg', description: (p) => `Gives you a ${p * 14}% chance to avoid interruption caused by damage while casting or channeling Unstable Affliction, Drain Life, Drain Mana, or Drain Soul.` },
...
While this effect is active, spells that require Soul Shards consume one skull instead.` },
            { id: 'emberstorm', name: 'Emberstorm', maxPoints: 1, row: 5, col: 2, prereq: 'shadow-and-flame', icon: 'spell_fire_selfdestruct.jpg', description: (p) => `Reduces the cooldown of your Soul Fire spell by 90% and increases your chance to hit with Soul Fire by 6% while both effects of Shadow and Flame are active.` },
