...
This effect is cancelled if any demon is summoned.` },
	...
	{ id: 'improved-searing-pain', name: 'Improved Searing Pain', maxPoints: 5, row: 1, col: 3, icon: 'spell_fire_soulburn.jpg', description: (p) => `Increases the critical strike chance of Searing Pain by ${p * 15}% on targets at or below 30% health.` },
...
While this effect is active, spells that require Soul Shards consume one skull instead.` },
 	...
 	{ id: 'infernum', name: 'Infernum', maxPoints: 3, row: 4, col: 3, icon: 'spell_fire_ragnaros_molteninferno.jpg', description: (p) => `Each time Hellfire deals damage to you, the cooldown of Inferno is reduced by ${p * 2} sec. In addition, Inferno can be used in any location, but the demon summoned will only obey you for 20 sec.` },
            { id: 'pyroclasm', name: 'Pyroclasm', maxPoints: 3, row: 5, col: 0, prereq: 'intensity', icon: 'spell_fire_volcano.jpg', description: (p) => `Increases the damage of Inferno, Rain of Fire, Hellfire and Hellflame Edict by ${p * 5}%. In addition, Rain of Fire has a ${p * 5}% chance to stun enemies hit for 3 sec.` },
