...
Can only be used after your pet lands a critical strike.` },
		...
		{ id: 'territorial-defense', name: 'Territorial Defense', maxPoints: 1, row: 4, col: 1, icon: 'inv_111_hunter_ability_harrierscall.jpg', details: ['30 yd range', '45 sec cooldown'], subDetails: ['10 Pet Focus', 'Instant'], description: () => `Call for aid, causing your pet to rush towards you, intercepting all melee and ranged attacks against you for 6 sec while you remain within 10 yds of each other.<hr>Shares a cooldown with Intimidation.` },
                { id: 'stalkers-ambition', name: 'Stalker\'s Ambition', maxPoints: 3, row: 4, col: 3, icon: 'ability_hunter_goforthethroat.jpg', description: (p) => `Your ranged and melee weapon attacks on marked targets have a ${p * 2}% chance to immediately activate Kill Command and increase its damage by ${p * 5}% for 10 sec.` },
	{ id: 'relentless-pursuit', name: 'Relentless Pursuit', maxPoints: 3, row: 5, col: 1, icon: 'inv_coordinatedassault.jpg', description: (p) => `Your Steady Shot and Raptor Strike critical hits restore ${p * 2} of your pet's Focus and increase the critical strike chance of their next special attack by ${p * 2}%. Lasts 10 sec.` },
		...
		{ id: 'bestial-tenacity', name: 'Bestial Tenacity', maxPoints: 5, row: 4, col: 2, icon: 'ability_mount_pinktiger.jpg', description: (p) => `Aspect of the Beast increases your Armor by ${p * 6}% and causes you to restore ${p * 1}% of your total health every 10 sec.` },
		...
		{ id: 'longevity', name: 'Longevity', maxPoints: 2, row: 6, prereq: 'bestial-wrath', col: 2, icon: 'ability_hunter_longevity.jpg', description: (p) => `Reduces the cooldown of your Bestial Wrath, Intimidation, Territorial Defense, Pet Special Abilities, and Bloodseeker talent by ${p * 10}%.` },
            ]
        },
        'marksmanship': {
            name: 'Marksmanship',
            talents: [
                ...
                { id: 'natural-efficiency', name: 'Natural Efficiency', maxPoints: 5, row: 0, col: 2, icon: 'ability_demonhunter_chaosnova.jpg', description: (p) => `Increases the Prowess generated by your Shot, Bite and Strike abilities by ${p * 2}%. This effect increases by an additional 5% versus Humanoids, Beasts and Giants.` },
